<template>
  <div>
    ...
    <div v-show="show" class="container-spotify-search" :style="{bottom: bottom + 'px', width: width + 'px'}">
      <!--{{ dataSpotify }}-->
...
export default {
  ...
  methods: {
    search () {
      ...
      this.bottom = (document.body.querySelector('#container-create-user').getBoundingClientRect().height) - 80
